...
export default function SupplierDeadStockPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">Dead Stock Alerts - Supplier View</h1>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-8 text-gray-500">No dead stock alerts found for your SKUs</div>
      ) : (
        <Card>
          <CardHeader>
