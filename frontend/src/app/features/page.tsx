...
export const metadata: Metadata = {
  title: 'Features',
  description: 'Discover all the powerful features that help you build and grow your online store.',
  openGraph: {
    title: 'Features - Revocart',
    description: 'Discover all the powerful features that help you build and grow your online store.',
    type: 'website',
  },
};
...
const extendedFeatures = [
  ...
  },
  {
    ...
    description: 'Easily manage your products, variants, and stock levels with our intuitive inventory system.',
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Streamline your order processing with automated workflows and real-time notifications.',
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Built-in email marketing, SEO optimization, and social media integration to grow your audience.',
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <Hero
          ...
          subtitle="Everything you need to build, manage, and grow your online business"
        ...
        <Features
          ...
          subtitle="All the tools you need in one platform"
