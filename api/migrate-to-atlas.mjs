 ...
 * 
 * Usage: node migrate-to-atlas.mjs
 * 
 * Make sure:
...
const ATLAS_URI = 'mongodb+srv://admin:Priyanka%4098@cluster0.mzws36m.mongodb.net/revocart';
...
migrateDatabase()
  .then(() => {
    ...
    console.log('   to: mongodb+srv://admin:Priyanka%4098@cluster0.mzws36m.mongodb.net/revocart');
    process.exit(0);
  })
  .catch((error) => {
    console.error('\n💥 Fatal error:', error);
